 ...
 * (data/locationsData.ts). Feeds `generateMetadata()` and the FAQPage JSON-LD
 * only; none of it renders as visible page content, so it doesn't change the
 * store page's design.
 *
 ...
 * `forest-hill-richmond-va`) so they match the `[location]` route param.
 */
  ...
  "bristow-va": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "10286 Bristow Center Dr, Bristow, VA 20136, off Linton Hall Road.",
      },
      {
  ...
  "philadelphia-pa": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes, through our online ordering, alongside pickup and dine-in.",
      },
    ],
  },
