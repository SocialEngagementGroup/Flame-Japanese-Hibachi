        ...
        <div className="grid grid-cols-2 min-[1100px]:grid-cols-4 gap-3 md:gap-6 w-full">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`group flex flex-col items-center justify-center text-center p-3 md:p-8 transition-all duration-300 border w-full aspect-[3/4] min-[1100px]:aspect-[281/375] ${
                  isFirst
              ...
              >
                <img
                  src={feature.icon}
                  alt={feature.title}
                  className={`w-[60px] h-[60px] md:w-[126px] md:h-[120px] object-contain mb-3 md:mb-6 transition-all duration-300 ${
