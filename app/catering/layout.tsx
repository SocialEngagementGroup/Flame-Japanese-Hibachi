...
// sibling route navigations in the App Router, so switching stores swaps
// only the page (Hero + banner) below — this heavy client tree (catering
// cards) and its images never unmount, decode, or refetch on a location
// switch.
